...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
		...
		self.backgroundColor = rgba(21, 160, 255,1);
...
- (void)ConfigParams
{
	...
	self.waveSpeed = self.waveSpeed == 0 ? 0.25 : self.waveSpeed;
    _waveSpeed = self.waveSpeed / M_PI;
